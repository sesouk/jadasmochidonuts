...
const Layout = ({ children }) => {
  return (
    ...
    <Header/>
      ...
      >
        <div style={{textAlign: 'center', paddingBottom: '2rem', paddingTop: '1rem'}}>We currently are not taking any online orders until 8/1. We apologize for the inconvenience but will be back soon 💜</div>
